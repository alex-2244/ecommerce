        ...
        <div class="row">
          <div class="col-lg-12">
                  ...
                  <tr class="cart_item">
                    ...
                    <td class="product-thumbnail">
                      ...
                      <div class="cart-product__item">
                        <a href="#">
                          <img src="{{ asset($pdt->model->image) }}" alt="product" width="100" height="100" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                        </a>
            ...
            <div class="cart-total">
                ...
                <h5 class="cart-total-total">Total: <span class="price">${{ Cart::total()
                   }}</span></h5>
